...
export default function Portfolio() {
  ...
  return (
      <main ref={container} className="relative overflow-x-hidden">
        {/* Navigation */}
        <nav
            className="fixed top-0 w-full z-50 flex justify-between items-center px-6 py-8 md:px-16 md:py-10 mix-blend-difference text-white">
        ...
        <section className="min-h-screen flex items-center px-6 md:px-16 pt-20 md:pt-0">
          <div className="max-w-7xl w-full mx-auto">
            ...
            <p className="hero-reveal max-w-lg text-lg md:text-2xl font-light opacity-60 leading-relaxed">
              An international public speaker and creative visionary crafting narratives that define the future of human
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div
              ...
              <Image
                  ...
                  priority
              />
              <div className="absolute bottom-4 left-4 text-[8px] uppercase tracking-widest opacity-40">Portrait //
                001
              </div>
            </div>
        ...
        <section id="features" className="py-24 md:py-40 px-6 md:px-16 bg-[#f0f0f0] dark:bg-zinc-950">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between md:items-end mb-12 md:mb-16 gap-4">
              <h2 className="section-header text-5xl md:text-8xl font-serif tracking-tighter italic">Featured
                Engagements</h2>
        ...
        <section id="speaking" className="py-24 md:py-48 px-6 md:px-16">
          <div className="max-w-5xl mx-auto">
            <h2 className="section-header text-5xl md:text-8xl font-serif mb-12 md:mb-24 tracking-tighter">Signature
              Keynotes</h2>
            <div className="divide-y divide-foreground/10 border-t border-foreground/10">
              {[
                {
                  title: "The Architecture of Influence",
                  desc: "Understanding how presence shapes professional trajectory."
                },
                ...
                {title: "Unredacted Speaker", desc: "How storytelling optimizes life clarity and growth."}
                  ...
                  <div key={i}
                       className="group py-12 md:py-16 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 hover:px-0 md:hover:px-8 transition-all duration-700 cursor-pointer">
                    ...
                    <div
                        className="hidden md:flex h-10 w-10 border border-foreground/20 rounded-full items-center justify-center group-hover:bg-foreground group-hover:text-background transition-all">
                      →
                    </div>
                  </div>
              ))}
        ...
        <footer id="contact" className="py-32 md:py-64 px-6 md:px-16 text-center">
          ...
          <div className="space-y-4">
            <a href="mailto:oyewoleope28@gmail.com"
               className="text-xl md:text-5xl font-serif border-b border-foreground/20 pb-2 md:pb-3 hover:opacity-50 transition-opacity inline-block tracking-tight">
              hello@oyewole.me
            </a>
            <div
                className="pt-12 md:pt-20 flex justify-center flex-wrap gap-8 md:gap-12 text-[9px] md:text-[10px] uppercase tracking-[0.4em] font-bold opacity-30">
              <a href="https://www.instagram.com/daniel_oyewole1?igsh=MTVoNjU4bTB2eXU1Zg%3D%3D&utm_source=qr"
                 target="_blank" rel="noopener noreferrer"
                 className="hover:opacity-100 transition-opacity">Instagram</a>
              <a href="https://www.linkedin.com/in/daniel-oyewole-7b898722a?utm_source=share_via&utm_content=profile&utm_medium=member_ios"
                 target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity">LinkedIn</a>
              <a href="https://wa.me/2349015037984" target="_blank" rel="noopener noreferrer"
                 className="hover:opacity-100 transition-opacity">Whatsapp</a>
              <a href="https://x.com/danieloyewole12?s=21" target="_blank" rel="noopener noreferrer"
                 className="hover:opacity-100 transition-opacity">Twitters / X</a>
            </div>
          </div>
        </footer>
      </main>
